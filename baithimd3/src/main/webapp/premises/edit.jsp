...
<div class="container mt-4">
    ...
    <form method="post" action="${pageContext.request.contextPath}/edit-premises">
        ...
        <div class="form-group btn-margin-top">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Update Premises</button>
